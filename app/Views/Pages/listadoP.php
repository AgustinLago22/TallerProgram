<div class="fondo-gestores">
    <div class="admin-panel">
        ...
        <!-- Contenedor de categoría Café -->
        <div class="category-container cafe-category">
            <h2>Café</h2>
            <table class="product-table cafe-table">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nombre</th>
        ...
        <!-- Contenedor de categoría Cafeteras -->
        <div class="category-container cafeteras-category">
            <h2>Cafeteras</h2>
            <table class="product-table cafeteras-table">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nombre</th>
        ...
        <div class="category-container tazas-category">
            <h2>Tazas</h2>
            <table class="product-table tazas-table">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nombre</th>
