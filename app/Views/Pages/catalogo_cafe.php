<div class="fondo-gestores">
    <div class="header-buttons">
        <a href="<?= base_url('/listado_productos/1') ?>" class="header-button">Café</a>
        <a href="<?= base_url('/listado_productos/2') ?>" class="header-button">Cafeteras</a>
        <a href="<?= base_url('/listado_productos/3') ?>" class="header-button">Tazas</a>
    </div>
